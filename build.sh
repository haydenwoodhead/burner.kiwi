...
CGO_ENABLED=0 packr build -ldflags "-X github.com/haydenwoodhead/burner.kiwi/server.version=${git_commit} -X github.com/haydenwoodhead/burner.kiwi/server.milligram=${milligram_name} -X github.com/haydenwoodhead/burner.kiwi/server.custom=${custom_name} -X github.com/haydenwoodhead/burner.kiwi/server.normalize=${normalize_name}" -o "./buildres/burnerkiwi"
